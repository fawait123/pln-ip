...
const results = ref<
  { id: number; part: string; quantity: string; unit: string }[]
>([]);
...
<template>
  <PopoverRoot v-model:open="modelOpenInputData">
    <PopoverTrigger>
      ...
      >
        {{ value && value?.length > 0 ? "Active" : "Part" }}
      </button>
    </PopoverTrigger>
    <PopoverPortal>
      <PopoverContent :side-offset="5" class="popover-form-part">
        ...
        <div class="popover-body">
          <p class="popover-body-title">Part</p>
