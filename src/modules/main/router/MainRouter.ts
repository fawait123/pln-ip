...
export const routeMain = [
  ...
  // },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/scope-mekanik",
    name: "scope mekanik",
    component: () => import("@/modules/main/views/scope/Mekanik.vue"),
    meta: { layout: MainLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/scope-listrik",
    name: "scope listrik",
    component: () => import("@/modules/main/views/scope/Listrik.vue"),
    meta: { layout: MainLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/scope-instrument",
  ...
  // },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/work-instruction-mekanik",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/work-instruction-listrik",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/work-instruction-instrument",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/consumable-material",
    name: "main consumable material",
    component: () => import("@/modules/main/views/ConsumableMaterial.vue"),
    meta: { layout: MainLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/manpower",
    name: "main manpower",
    component: () => import("@/modules/main/views/Manpower.vue"),
    meta: { layout: MainLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/part",
    name: "main part",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/qc-plan",
    name: "main qc plan",
    component: () => import("@/modules/main/views/QcPlan.vue"),
    meta: { layout: MainLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/squences",
    name: "main squences",
    component: () => import("@/modules/scope/views/Sequence.vue"),
    meta: { layout: DefaultLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/preview",
    name: "preview",
    component: () => import("@/modules/main/views/Preview.vue"),
    meta: { layout: MainLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/results",
    name: "results",
    component: () => import("@/modules/main/views/Results.vue"),
    meta: { layout: MainLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope",
    name: "main add scope",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/scope-listrik",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/scope-instrument",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/work-instruction-mekanik",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/work-instruction-listrik",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/work-instruction-instrument",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/consumable-material",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/manpower",
  ...
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/part",
    name: "add scope detail part",
    component: () => import("@/modules/main/views/add-scope-detail/Part.vue"),
    meta: { layout: AddScopeLayout, requireAuth: true },
  },
  {
    path: "/:id/create/unit/:id_unit/:menu/:id_project/add-scope/:id_scope/qc-plan",
