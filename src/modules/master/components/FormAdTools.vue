...
<template>
    <Modal width="440" height="200" :showButtonClose="false" title="Tambah Tools" v-model="modelValue">
        <form class="flex flex-col gap-4 max-h-[calc(100vh-200px)] overflow-y-auto mx-[-20px] px-5"
            ...
            <Input v-model="model.qty" label="Quantity" :rules="rules.qty"
            ...
            <Select v-model="model.global_unit_uuid" label="Global Unit" options_label="label" options_value="value"
                ...
                :loading-next-page="isFetchingNextPageGlobalUnit" :rules="rules.global_unit_uuid"
                :options="options_global_unit" @scroll="scrollGlobalUnit" @search="searchGlobalUnit" />
